...
function _sylvanas() {
  const data = require("sylvanas");

  _sylvanas = function _sylvanas() {
    return data;
  };
...
function demoHandler(h, _ref) {
  ...
  const source = {}; // set source code

  if (lang === 'tsx') {
    source.tsx = clonedNode.value;
    source.jsx = (0, _sylvanas().parseText)(clonedNode.value);
  } else {
...
var _default = () => (0, _remarkRehype().default)({
  handlers: {
    demo: demoHandler
  },
