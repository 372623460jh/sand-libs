...
var _default = (api, opts) => {
  ...
  if (opts.routes) {
    ...
    childRoutes.push(...opts.routes.map((_ref) => {
      let component = _ref.component,
          routeOpts = _objectWithoutProperties(_ref, ["component"]);
  ...
  config.push({
    path: '/',
    component: (0, _slash().default)(_path().default.relative(_path().default.join(paths.absTmpPath, 'core'), _path().default.join(__dirname, '../themes/default/layout.js'))),
  ...
  config[0].routes.forEach(route => {
    ...
    if ((_route$meta = route.meta) === null || _route$meta === void 0 ? void 0 : _route$meta.example) {
      ...
      route.component = _path().default.relative(_path().default.join(paths.absTmpPath, 'core'), _path().default.join(__dirname, '../themes/default/builtins/Example.js'));
