      ...
      menuItem.children = menu.children.map(child => {
        ...
        if (typeof child === 'string') {
          ...
          const route = routes.find(route => {
            ...
            if (route.component && isSameRouteComponent(child, route.component, includes, paths) && (((_route$meta = route.meta) === null || _route$meta === void 0 ? void 0 : _route$meta.locale) === locale || !((_route$meta2 = route.meta) === null || _route$meta2 === void 0 ? void 0 : _route$meta2.locale) && isDefaultLocale)) {
              return true;
            }
          });
          ...
          route.meta.group = _objectSpread(_objectSpread({
            ...
            path: menu.path
          } : {}), ((_route$meta3 = route.meta) === null || _route$meta3 === void 0 ? void 0 : _route$meta3.group) || {});
        }
...
function addHtmlSuffix(oPath) {
  var _ctx$umi, _ctx$umi$config, _ctx$umi$config$expor;

  if (oPath && ((_ctx$umi = _context.default.umi) === null || _ctx$umi === void 0 ? void 0 : (_ctx$umi$config = _ctx$umi.config) === null || _ctx$umi$config === void 0 ? void 0 : (_ctx$umi$config$expor = _ctx$umi$config.exportStatic) === null || _ctx$umi$config$expor === void 0 ? void 0 : _ctx$umi$config$expor.htmlSuffix)) {
    return `${oPath}.html`;
  }
...
function getMenuFromRoutes(routes, opts, paths) {
  ...
  routes.forEach(route => {
    if (isValidMenuRoutes(route)) {
      var _route$meta$nav, _opts$locales$, _route$meta4;
      ...
      const locale = route.meta.locale || ((_opts$locales$ = opts.locales[0]) === null || _opts$locales$ === void 0 ? void 0 : _opts$locales$[0]) || '*';
      const menuItem = {
        path: route.path,
        title: route.title,
        meta: {}
      ...
      if (typeof ((_route$meta4 = route.meta) === null || _route$meta4 === void 0 ? void 0 : _route$meta4.order) === 'number') {
      ...
      if (group === null || group === void 0 ? void 0 : group.path) {
        ...
        const groupKey = addHtmlSuffix(group.path) || group.title; // group route items by group path & locale
